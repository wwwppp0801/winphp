...
{%block name="content"%}
        ...
        <form action="/index/addApply" method="post">
			<div class="left">
                ...
                <span class="list"><input name="phone" type="text" class="input1" /></span>
                <span class="list"><span class="num">2、</span>（必选）您的电子邮箱：</span>
                <span class="list"><input name="email" type="text" class="input1" /></span>
                <span class="list"><span class="num">3、</span>（必选）您对养乐多产品的是否了解（了解或者不了解）</span>
                <span class="list"><input name="awareness" type="text" class="input1" /></span>
            </div>
			<div class="right">
